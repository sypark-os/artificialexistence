...
class SelfImageTracker:
    ...
    def update(self, sentiment, is_self_talk=True, energy_factor=0.5, timestamp=None, energy_ratio=None): # Adjusted: dynamic energy_factor scaling with 0.1 floor for growth continuity
