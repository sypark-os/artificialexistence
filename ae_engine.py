...
class SelfImageTracker:
    ...
    def update(self, sentiment, is_self_talk=True, energy_factor=0.5, timestamp=None, energy_ratio=None): # Adjusted: dynamic energy_factor scaling based on (1.0 - energy_ratio)
