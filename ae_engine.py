...
class SelfImageTracker:
    ...
    def update(self, sentiment, is_self_talk=True, energy_factor=None, timestamp=None, energy_ratio=None, damping=0.1): # Adjusted: clamp energy_ratio to [0.0, 1.0] and apply damping to stabilize scaling.
